 ...
 * Description : send package file from frontend build to backend (production)
 * Exec (init) : yarn add -D form-data archiver && yarn add axios
 */

// =============================================== //

const backend_url = 'http://localhost:5000';
const password = 'your_rfp_password';
